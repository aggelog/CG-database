...
void initHatchingControl()
{
	Hatching_Bar = TwNewBar("Hatching_Control_Bar");

	TwDefine("Hatching_Control_Bar label='Hatching Control TwBar' position='16 380' alpha=0 help='Use this bar to control the objects of the scene.' ");

	TwAddVarRW(Hatching_Bar, "Light Position", TW_TYPE_DIR3F, &LightPosition," label='Light Position' ");
	TwAddVarRW(Hatching_Bar, "Scale Factor", TW_TYPE_FLOAT, &Scale, "min=0.01 max=10.0 step=0.01 label='Scale Factor' ");
	TwAddVarRW(Hatching_Bar, "Time", TW_TYPE_FLOAT, &Time, "readonly=true label='Time' ");
}
